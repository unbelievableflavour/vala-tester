...
public class Preferences : Gtk.Dialog {
    ...
    public Preferences () {
        ...
        var vala_path_label = new Gtk.Label (_("Vala path:"));
        var vala_path_entry = new Gtk.Entry ();
        vala_path_entry.set_text (settings.get_string ("vala-path"));
        vala_path_entry.set_tooltip_text (_("This path will be used to find vala"));

        var restartNoteLabel = new Gtk.Label (_("You need to restart after changing the Vala path"));
        ...
        save_button.clicked.connect (() => {
            ...
            if (vala_path_entry.text == "") {
                settings.set_string ("vala-path", "/usr/bin");
            } else {
                settings.set_string ("vala-path", vala_path_entry.text);
            }
        ...
        general_grid.attach (vala_path_label, 0, 3, 1, 1);
        general_grid.attach (vala_path_entry, 1, 3, 1, 1);
